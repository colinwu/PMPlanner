module ApplicationHelper
  ...
  def pm_status_class(dev)
    range = dev.try(:primary_tech).try(:preference).try(:upcoming_interval) ? dev.primary_tech.preference.upcoming_interval * 7 : current_user.preference.upcoming_interval * 7
